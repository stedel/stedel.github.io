        ...
        window.onkeydown = function(evt) {
            ...
            switch(evt.keyCode) {
                ...
                case(107): // numblock plus
                    if (depth >= 9) {
                        $('#recursionDepth').html('Aktuelle Rekursionstiefe: ' + depth + '<br> Erhöhung nicht möglich, da ansonsten durch die aufwendigen Berechnungen Fehler auftreten können.');
...
Circle.prototype.draw = function(wireFrame, prog) {
    ...
    gl.bindBuffer(gl.ARRAY_BUFFER, this.vertexPositionBuffer);
    gl.vertexAttribPointer(prog.posAttrib, this.vertexPositionBuffer.itemSize, gl.FLOAT, false, 0, 0);

    gl.bindBuffer(gl.ARRAY_BUFFER, this.vertexColorBuffer);
    gl.vertexAttribPointer(prog.colorAttrib, this.vertexColorBuffer.itemSize, gl.FLOAT, false, 0, 0);
