...
const ANIMATION_SEQUENCE = [0, 1, 2, 3, 2, 1, 2, 3, 0, 0, 0, 4, 4, 5, 6, 7, 6, 5, 6, 7, 4, 4, 0];
...
function startSpriteAnimation() {
    if (currentAnimationFrame === 0) {
        spritesheetAnimationIntervalId = setInterval(animateSprite, SPRITESHEET_FRAMETIME);
    }
}
...
function animateSprite() {
    ...
    updateSpriteCss(SPRITESHEET_POSITIONS[currentSpritePositionIndex][0], SPRITESHEET_POSITIONS[currentSpritePositionIndex][1]);
}
